...
function MessageBar() {
  ...
  return (
      <div className="h-[10vh] bg-[#1c1d25] flex justify-center items-center px-3 sm:px-8 mb-6 gap-2 sm:gap-6">
        ...
        <button className='bg-[#8417ff] rounded-md flex items-center justify-center p-3 sm:p-5 focus:border-none hover:bg-[#741bda] focus:bg-[#741bda] focus:outline-none focus:text-white duration-300 transition-all'
